        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CagesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cats_Breeds_BreedsId",
                        column: x => x.BreedsId,
                        principalTable: "Breeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cats_Cages_CagesId",
                        column: x => x.CagesId,
                        principalTable: "Cages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cats_Vaccines_VaccinesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adoptions_AspNetUsers_ClientsId",
                        column: x => x.ClientsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Adoptions_Cats_CatsId",
                        column: x => x.CatsId,
                        principalTable: "Cats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adoptions_CatsId",
                table: "Adoptions",
                column: "CatsId");

            migrationBuilder.CreateIndex(
                name: "IX_Adoptions_ClientsId",
                table: "Adoptions",
                column: "ClientsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cats_BreedsId",
                table: "Cats",
                column: "BreedsId");

            migrationBuilder.CreateIndex(
                name: "IX_Cats_CagesId",
                table: "Cats",
                column: "CagesId");

            migrationBuilder.CreateIndex(
                name: "IX_Cats_VaccinesId",
                table: "Cats",
                column: "VaccinesId");
        }
