...
namespace CatShelter.Controllers
{
    public class DonationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Payment")] Donation donation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Payment")] Donation donation)
        {
            if (id != donation.Id)
            {
                return NotFound();
